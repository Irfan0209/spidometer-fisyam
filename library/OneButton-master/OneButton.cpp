...
OneButton::OneButton(int pin, int activeLow)
{
  ...
  _clickTicks = 50;//600;        // number of millisec that have to pass by before a click is detected.
  _pressTicks = 100;//1000;       // number of millisec that have to pass by before a long button press is detected.
